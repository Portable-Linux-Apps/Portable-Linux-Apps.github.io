...
| <img loading="lazy" src="icons/kde-webapp-gen.png" width="48" height="48"><span class="arch-data" data-arch="x86_64" hidden></span> | [***kde-webapp-gen***](apps/kde-webapp-gen.md) | *A native Qt6/PyQt6 utility for KDE Plasma to create and manage custom browser webapps with isolated profiles, custom window sizes, and automated KWin window rules for perfect Wayland/X11 taskbar icon grouping.*..[ *read more* ](apps/kde-webapp-gen.md)*!* | [*blob*](https://github.com/ivan-hc/AM/blob/main/programs/x86_64/kde-webapp-gen) **/** [*raw*](https://raw.githubusercontent.com/ivan-hc/AM/main/programs/x86_64/kde-webapp-gen) |
