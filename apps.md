...
## ◆ [*am*](apps/am.md) 
 A.M. is this Application Manager, use the "am -h" command for more info. 
...
## ◆ [*appman*](apps/appman.md) 
 "AM" fork that installs the same pps locally (no root needed).  
...
## ◆ [*corepak*](apps/corepak.md) 
 Experimental tool (installer for "node"). 
...
## ◆ [*dfilemanager*](apps/dfilemanager.md) 
 Browse files.
File manager written in Qt and C++. 
...
Images to shapes converter (graphics). 
...
Multiplatform mind map and outliner editor with markdown support.  
...
## ◆ [*meta-grabber*](apps/meta-grabber.md) 
 A tool to grab metadata for tv shows and rename files on PC.
Grab meta data for tv shows and rename files locally. 
...
## ◆ [*mlv-app*](apps/mlv-app.md) 
 All in one MLV processing app (audio/video).
...
## ◆ [*nostlan*](apps/nostlan.md) 
 A multiplatform game launcher for video game emulators!
Front-end launcher for retro/current gen game emulators. 
...
## ◆ [*serial-studio*](apps/serial-studio.md) 
 Multi-purpose serial data view program.
...
## ◆ [*sigdigger*](apps/sigdigger.md) 
 Signal analyzer, using Suscan core and Sigutils DSP library. 
...
Source explorer to get you productive on unfamiliar source code. 
...
## ◆ [*spivak*](apps/spivak.md) 
 Karaoke player based on GStreamer and Qt5.
...
## ◆ [*vlc+*](apps/vlc+.md) 
 Video & Media player for Audio, streaming and more (with plugins). 
