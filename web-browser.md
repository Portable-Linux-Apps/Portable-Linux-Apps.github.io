...
#### Here are listed **75** programs and **0** items for this category.
...
| <img loading="lazy" src="icons/firefox-devedition.png" width="48" height="48"> | [***firefox-devedition***](apps/firefox-devedition.md) | *Fast, powerful and extensible Web Browser, Developer Edition.*..[ *read more* ](apps/firefox-devedition.md)*!* | [*blob*](https://github.com/ivan-hc/AM/blob/main/programs/x86_64/firefox-devedition) **/** [*raw*](https://raw.githubusercontent.com/ivan-hc/AM/main/programs/x86_64/firefox-devedition) |
